...
import 'package:foodflow_app/models/almacen_model.dart';
...
class InventarioService {
  ...
  Future<List<Almacen>> obtenerInventario() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return almacenData.map((item) => Almacen.fromJson(item)).toList();
      }
